...
"C:\Program Files (x86)\GnuWin32\bin\zip.exe" -r -v -g Calico-2.4.4-windows-all.zip "Calico/modules/*.dll" "Calico/modules/Myro/Robots/*.dll" "Calico/modules/Myro/Robots/Worlds/*.py"
