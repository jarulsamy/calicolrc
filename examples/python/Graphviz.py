...
tree = """digraph {
        ...
        14 -> 7 [pos="e,58.226,185.32 73,223 73,212.77 68.994,202.66 63.861,193.9"];
        14 -> 26 [pos="e,143.77,185.32 129,223 129,212.77 133.01,202.66 138.14,193.9"];
        7 -> 12 [pos="e,52.328,111.06 66,149 66,138.84 62.264,128.62 57.521,119.76"];
        26 -> 20 [pos="e,132,111.16 132,149 132,140.01 132,130.22 132,121.37"];
        26 -> 31 [pos="e,205.67,111.19 188,149 188,138.14 192.96,127.82 199.29,119.06"];
        20 -> 17 [pos="e,104,37.159 104,75 104,66.015 104,56.218 104,47.367"];
}
"""
