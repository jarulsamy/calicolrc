...
import pio as io
from pio import (__all__, SEEK_SET, SEEK_CUR, SEEK_END)
...
class _BufferedIOMixin(BufferedIOBase):
    ...
    def __repr__(self):
        ...
        try:
            ...
            return "<io.{0}>".format(clsname)
        else:
            return "<io.{0} name={1!r}>".format(clsname, name)
...
class TextIOWrapper(TextIOBase):
    ...
    def __repr__(self):
        try:
            ...
            return "<io.TextIOWrapper encoding='{0}'>".format(self.encoding)
        else:
            return "<io.TextIOWrapper name={0!r} encoding='{1}'>".format(
                name, self.encoding)
