public class DragDropBug {
  ...
  public static void Main(string [] args) {
	...
	treeview.DragDataGet += new Gtk.DragDataGetHandler(DragDropBug.treeviewHandleSourceDragDataGet);
  ...
  public static void treeviewHandleSourceDragDataGet(object obj, Gtk.DragDataGetArgs args) {
	System.Console.WriteLine("treeviewHandleSourceDragDataGet!");
	System.Console.WriteLine("dnd get {0}", args.Context.Targets);
  }
}