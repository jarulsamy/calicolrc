...
namespace Calico
{
	public partial class MainWindow
	{
		...
		private global::Gtk.Action RemoveModuleAction;
		...
		private global::Gtk.Action ChangeDirectoryAction;
		...
		private global::Gtk.Action ResetOptionsAction;
		...
		protected virtual void Build()
		{
			...
			w1.Add (this.indentAction, GetControlString() + "<Mod2>bracketleft");
			...
			w1.Add (this.unindentAction, GetControlString() + "<Mod2>bracketright");
			...
			w1.Add (this.CommentRegionAction, GetControlString() + "<Mod2>braceleft");
			...
			w1.Add (this.UncommentRegionAction, GetControlString() + "<Mod2>braceright");
			...
			w1.Add (this.zoomInAction, GetControlString() + "plus");
			...
			w1.Add (this.zoomOutAction, GetControlString() + "minus");
			...
			w1.Add (this.Option1Action, GetControlString() + "1");
			...
			w1.Add (this.Option2Action, GetControlString() + "2");
			...
			this.RemoveModuleAction = new global::Gtk.Action ("RemoveModuleAction", global::Mono.Unix.Catalog.GetString("Remove a Module..."), null, null);
			this.RemoveModuleAction.ShortLabel = global::Mono.Unix.Catalog.GetString("Remove a Module...");
			w1.Add (this.RemoveModuleAction, null);
			...
			w1.Add (this.ToggleBreakpointAction, GetControlString() + "period");
			this.ChangeDirectoryAction = new global::Gtk.Action ("ChangeDirectoryAction", global::Mono.Unix.Catalog.GetString("Change to Directory"), null, null);
			this.ChangeDirectoryAction.ShortLabel = global::Mono.Unix.Catalog.GetString("Change to Directory");
			w1.Add (this.ChangeDirectoryAction, null);
			...
			this.ScriptOptionsAction.ShortLabel = global::Mono.Unix.Catalog.GetString("Script Options");
			...
			w1.Add (this.FindPreviousAction, GetControlString() + "<Mod2>r");
			...
			this.ResetOptionsAction = new global::Gtk.Action ("ResetOptionsAction", global::Mono.Unix.Catalog.GetString("Reset Options..."), null, null);
			this.ResetOptionsAction.ShortLabel = global::Mono.Unix.Catalog.GetString("Reset Options...");
			w1.Add (this.ResetOptionsAction, null);
			...
			w1.Add (this.FindNextAction, GetControlString() + "<Mod2>g");
			...
			this.RemoveModuleAction.Activated += new global::System.EventHandler (this.OnRemoveModuleActionActivated);
			...
			this.ChangeDirectoryAction.Activated += new global::System.EventHandler (this.OnChangeDirectoryActionActivated);
			...
			//this.ResetOptionsAction.Activated += new global::System.EventHandler (this.ResetOptionsActionActivated);
