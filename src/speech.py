# Festival
# $ festval
festival> Voice_descriptions
((kal_diphone
  ((language english)
   (gender male)
   (dialect american)
   (description
    "This voice provides an American English male ..."))))

#voice_rab_diphone
#A British English male RP speaker, Roger.
#voice_ked_diphone
#An American English male speaker, Kurt.
#voice_kal_diphone
#An American English male speaker.
#voice_don_diphone
#Steve Isard's LPC based diphone synthesizer, Donovan diphones.
#voice_el_diphone
#A male Castilian Spanish speaker
#voice_gsw_diphone
#This offers a male RP speaker, Gordon
#voice_en1_mbrola
#The Roger diphone set using the same front end as voice_rab_diphone
#voice_us1_mbrola
#A female Amercian English voice
#voice_us2_mbrola
#A male Amercian English voice
#voice_us3_mbrola
#Another male Amercian English voice
...
class TTSEngine:
    def __init__(self, name = None, echo=True):
        self.name = name
        self.echo = echo
