...
def b_proc_163_d(external_function_object):
    GLOBALS['value2_reg'] = fail_reg
...
def make_external_proc(external_function_object):
    return make_proc(b_proc_163_d, external_function_object)
...
list_q_prim = make_proc(b_proc_145_d)
procedure_q_prim = make_proc(b_proc_146_d)
stringLessThan_q_prim = make_proc(b_proc_147_d)
float_prim = make_proc(b_proc_148_d)
globals_prim = make_proc(b_proc_149_d)
int_prim = make_proc(b_proc_150_d)
apply_with_keywords_prim = make_proc(b_proc_151_d)
assq_prim = make_proc(b_proc_152_d)
dict_prim = make_proc(b_proc_153_d)
property_prim = make_proc(b_proc_154_d)
rational_prim = make_proc(b_proc_155_d)
reset_toplevel_env_prim = make_proc(b_proc_156_d)
sort_prim = make_proc(b_proc_157_d)
string_append_prim = make_proc(b_proc_158_d)
string_split_prim = make_proc(b_proc_159_d)
symbol_prim = make_proc(b_proc_160_d)
typeof_prim = make_proc(b_proc_161_d)
use_lexical_address_prim = make_proc(b_proc_162_d)
