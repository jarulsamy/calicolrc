...
def b_handler2_4_d(cexps, cvar, env, handler, k):
    ...
    new_env = extend(env, List(cvar), List(exception_reg), List(""))
    GLOBALS['k_reg'] = k
    GLOBALS['handler_reg'] = handler
