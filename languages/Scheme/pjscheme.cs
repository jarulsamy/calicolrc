...
public class PJScheme:Scheme
{
   ...
   {
      return ((object) PJScheme.
	      cons ((object) symbol ("func-exp"), (object) args));
   }
   ...
   new public static void apply_cont ()
   {
	 ...
	 if (true_q
		     ...
		     (object) symbol ("<cont-34>"))))
	   {
	      object k = null;
	      k = PJScheme.list_ref ((object) temp_1, (object) 1);
	      value_reg = PJScheme.func_exp ((object) value_reg);
	      k_reg = k;
	      pc = (Function) apply_cont;
	   }
	 else
	   ...
	   {
	      k_reg = PJScheme.make_cont ((object) symbol ("<cont-57>"));
	      handler_reg = REP_handler;
	      env_reg = toplevel_env;
	      exp_reg = value_reg;
	      pc = (Function) m;
		     ...
		     (object) symbol ("<cont-78>"))))
	   {
	      object k = null;
	      k = PJScheme.list_ref ((object) temp_1, (object) 1);
	      value_reg = PJScheme.dlr_func ((object) value_reg);
	      k_reg = k;
	      pc = (Function) apply_cont;
	   }
	 else
   ...
   new public static void apply_cont2 ()
   {
	 ...
	 if (true_q
	   ...
	   {
	      k_reg = PJScheme.make_cont ((object) symbol ("<cont-100>"));
	      handler_reg = init_handler;
	      datum_reg = value1_reg;
	      pc = (Function) parse;
   ...
   new public static void lookup_module_binding ()
   {
	 ...
	 if (true_q (binding))
	   ...
	   {
	      value_reg = PJScheme.dlr_env_lookup ((object) var_reg);
	      pc = (Function) apply_cont;
		  ...
		  (object) symbol ("define!-exp"))))
	{
	   ...
	   if (true_q
		...
		pc = (Function) m;
	     ...
	     {
		k_reg =
		   PJScheme.make_cont ((object) symbol ("<cont-69>"),
				       (object) rhs_exp, (object) var,
				       (object) env_reg, (object) handler_reg,
				       (object) k_reg);
		exp_reg = PJScheme.cadr ((object) rhs_exp);
   ...
   new public static void map_prim ()
   {
	...
	{
	   iterator_reg = PJScheme.car ((object) args_reg);
	   pc = (Function) iterate_collect;
	 ...
	 if (true_q (PJScheme.null_q ((object) item)))
	 ...
	 else
	   {
		 ...
		 PJScheme.make_cont ((object) symbol ("<cont-83>"),
				     (object) iterator_reg, (object) proc_reg,
				     (object) env_reg, (object) handler_reg,
				     (object) k_reg);
	      env2_reg = env_reg;
   ...
   new public static void for_each_prim ()
   {
	...
	{
	   iterator_reg = PJScheme.car ((object) lists_reg);
	   pc = (Function) iterate;
   ...
   {
      k_reg =
	 PJScheme.make_cont ((object) symbol ("<cont-99>"), (object) k_reg);
   ...
   new public static object dlr_func (object exp, object env)
   {
      k_reg = init_cont;
      handler_reg = init_handler;
      env_reg = env;
   ...
   new public static void instantiate ()
   {
	...
	{
	   k_reg =
	      PJScheme.make_cont ((object) symbol ("<cont-107>"),
   ...
   new public static void apply_sub ()
   {
	 ...
	 if (true_q
		     ...
		     (object) symbol ("composite"))))
	   {
	      ...
	      k_reg =
		 PJScheme.make_cont ((object) symbol ("<cont-108>"),
   ...
   static Func < object, bool > quote_q =
      PJScheme.tagged_list ((object) symbol ("quote"), (Predicate2) EqualSign,
			    (object) 2);
   static Func < object, bool > func_q =
      PJScheme.tagged_list ((object) symbol ("func"), (Predicate2) EqualSign,
			    (object) 2);
   ...
   static Func < object, bool > define_b_q =
      PJScheme.tagged_list ((object) symbol ("define!"),
			    (Predicate2) GreaterOrEqual, (object) 3);
