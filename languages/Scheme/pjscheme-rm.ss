                                                                                              ...
                                                                                              (if (eq? (car temp_1) '<cont2-23>)
                                                                                                  ...
                                                                                                  (if (eq? (car temp_1) '<cont2-24>)
                                                                                                      (let ((env 'undefined) (handler 'undefined) (k 'undefined))
                                                                                                        ...
                                                                                                        (set! k_reg (make-cont '<cont-95> value2_reg env handler k))
                                                                                                        (set! handler_reg handler)
                                                                                                        (set! datum_reg value1_reg)
                                                                                                        (set! pc parse))
                                                                                                      (if (eq? (car temp_1) '<cont2-25>)
                                                                                                          (begin
                                                                                                            (set! k_reg (make-cont '<cont-98>))
                                                                                                            (set! handler_reg init-handler)
                                                                                                            (set! datum_reg value1_reg)
                                                                                                            (set! pc parse))
                                                                                                          (error 'apply-cont2
...
(define*
  ...
  (lambda ()
    (if (null? list1_reg)
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg (make-cont '<cont-84> list1_reg proc_reg k_reg))
              (set! list1_reg (cdr list1_reg))
              (set! pc map1))
            (begin
              (set! k2_reg
                (make-cont '<cont-83> list1_reg proc_reg env_reg handler_reg
                  k_reg))
  ...
  (lambda ()
    (if (null? list1_reg)
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg
                (make-cont '<cont-86> list1_reg list2_reg proc_reg k_reg))
              (set! list2_reg (cdr list2_reg))
              (set! list1_reg (cdr list1_reg))
              (set! pc map2))
            (begin
              (set! k2_reg
                (make-cont '<cont-85> list1_reg list2_reg proc_reg env_reg
                  handler_reg k_reg))
              (set! env2_reg env_reg)
...
(define*
  ...
  (lambda ()
    (if (null? (car lists_reg))
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg (make-cont '<cont-88> lists_reg proc_reg k_reg))
              (set! lists_reg (map cdr lists_reg))
              (set! pc mapN))
            (begin
              (set! k2_reg
                (make-cont '<cont-87> lists_reg proc_reg env_reg handler_reg
                  k_reg))
              (set! env2_reg env_reg)
    ...
    (let ((arg-list 'undefined))
      ...
      (if (null? (car arg-list))
          ...
          (if (dlr-exp? proc_reg)
              ...
              (begin
                (set! k2_reg
                  (make-cont '<cont-89> arg-list proc_reg env_reg handler_reg
                    k_reg))
                (set! env2_reg env_reg)
...
(define*
  ...
  (lambda ()
    (let ((sym 'undefined))
      ...
      (set! k_reg
        (make-cont '<cont-90> args_reg sym handler_reg k_reg))
    ...
    (let ((filename 'undefined))
      ...
      (if (null? (cdr args_reg))
          ...
          (let ((module-name 'undefined))
            ...
            (set! k_reg
              (make-cont '<cont-91> filename env_reg handler_reg k_reg))
        ...
        (if (not (string? filename_reg))
            ...
            (if (not (file-exists? filename_reg))
                ...
                (begin
                  ...
                  (set! k_reg
                    (make-cont '<cont-93> env_reg handler_reg k_reg))
...
(define*
  ...
  (lambda ()
    (if (null? filenames_reg)
        ...
        (begin
          (set! k_reg
            (make-cont '<cont-96> filenames_reg env_reg handler_reg
              k_reg))
...
(define*
  help-prim
  (lambda ()
    (set! k_reg (make-cont '<cont-97> k_reg))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (begin
              (set! k_reg
                (make-cont '<cont-99> pattern_reg var_reg k_reg))
    ...
    (if (pattern-variable? p1_reg)
        (if (pattern-variable? p2_reg)
            (begin
              ...
              (set! pc apply-cont))
            (begin
              (set! k_reg (make-cont '<cont-100> p1_reg p2_reg k_reg))
...
(define*
  ...
  (lambda ()
    (set! k_reg
      (make-cont '<cont-104> pair1_reg pair2_reg k_reg))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (if (pair? pattern_reg)
                (begin
                  (set! k_reg (make-cont '<cont-105> pattern_reg s_reg k_reg))
                  (set! pattern_reg (car pattern_reg))
                  (set! pc instantiate))
          ...
          (if (eq? (car temp_1) 'unit)
              ...
              (if (eq? (car temp_1) 'composite)
                  (let ((s1 'undefined) (s2 'undefined))
                    ...
                    (set! k_reg (make-cont '<cont-106> s2 k_reg))
                    (set! s_reg s1)
                    (set! pc apply-sub))
