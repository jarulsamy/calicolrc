...
(define global-exp
  (lambda args (return* (cons 'global-exp args))))
                                                                                                          ...
                                                                                                          (if (eq? (car temp_1) '<cont-26>)
                                                                                                              ...
                                                                                                              (if (eq? (car temp_1) '<cont-27>)
                                                                                                                  (let ((datum 'undefined) (k 'undefined))
                                                                                                                    (set! k (list-ref temp_1 2))
                                                                                                                    (set! datum (list-ref temp_1 1))
                                                                                                                    (set! value_reg (global-exp (cadr datum) (list value_reg)))
                                                                                                                    (set! k_reg k)
                                                                                                                    (set! pc apply-cont))
                                                                                                                  (if (eq? (car temp_1) '<cont-28>)
                                                                                                                      ...
                                                                                                                      (if (eq? (car temp_1) '<cont-29>)
                                                                                                                          (let ((datum 'undefined)
                                                                                                                            ...
                                                                                                                            (set! handler (list-ref temp_1 2))
                                                                                                                            (set! datum (list-ref temp_1 1))
                                                                                                                            (set! k_reg (make-cont '<cont-28> datum value_reg k))
                                                                                                                            (set! handler_reg handler)
                                                                                                                                      ...
                                                                                                                                      (if (eq? (car temp_1) '<cont-33>)
                                                                                                                                          ...
                                                                                                                                          (if (eq? (car temp_1) '<cont-34>)
                                                                                                                                              (let ((datum 'undefined)
                                                                                                                                                ...
                                                                                                                                                (set! datum (list-ref temp_1 1))
                                                                                                                                                (set! k_reg (make-cont '<cont-33> v1 value_reg k))
                                                                                                                                                (set! handler_reg handler)
                                                                                                                                              ...
                                                                                                                                              (if (eq? (car temp_1) '<cont-35>)
                                                                                                                                                  (let ((datum 'undefined)
                                                                                                                                                    ...
                                                                                                                                                    (set! datum (list-ref temp_1 1))
                                                                                                                                                    (set! k_reg
                                                                                                                                                      (make-cont '<cont-34> datum value_reg handler k))
                                                                                                                                                    (set! handler_reg handler)
                                                                                                                                                    (set! datum_reg (caddr datum))
                                                                                                                                                    (set! pc parse))
                                                                                                                                                          ...
                                                                                                                                                          (if (eq? (car temp_1) '<cont-38>)
                                                                                                                                                              ...
                                                                                                                                                              (if (eq? (car temp_1) '<cont-39>)
                                                                                                                                                                  (let ((a 'undefined)
                                                                                                                                                                    ...
                                                                                                                                                                    (set! a (list-ref temp_1 1))
                                                                                                                                                                    (set! k_reg (make-cont '<cont-38> a value_reg k))
                                                                                                                                                                    (set! handler_reg handler)
                                                                                                                                                                  ...
                                                                                                                                                                  (if (eq? (car temp_1) '<cont-40>)
                                                                                                                                                                      (let ((pairs 'undefined)
                                                                                                                                                                        ...
                                                                                                                                                                        (set! k_reg
                                                                                                                                                                          (make-cont '<cont-39> value_reg pairs handler k))
                                                                                                                                                                        (set! handler_reg handler)
                                                                                                                                                                      ...
                                                                                                                                                                      (if (eq? (car temp_1) '<cont-41>)
                                                                                                                                                                          ...
                                                                                                                                                                          (if (eq? (car temp_1) '<cont-42>)
                                                                                                                                                                              (let ((datum-list 'undefined)
                                                                                                                                                                                ...
                                                                                                                                                                                (set! k_reg (make-cont '<cont-41> value_reg k))
                                                                                                                                                                                (set! handler_reg handler)
                                                                                                                                                                              ...
                                                                                                                                                                              (if (eq? (car temp_1) '<cont-43>)
                                                                                                                                                                                  ...
                                                                                                                                                                                  (if (eq? (car temp_1) '<cont-44>)
                                                                                                                                                                                      (let ((datum 'undefined)
                                                                                                                                                                                        ...
                                                                                                                                                                                        (set! handler (list-ref temp_1 2))
                                                                                                                                                                                        (set! datum (list-ref temp_1 1))
                                                                                                                                                                                        (set! k_reg (make-cont '<cont-43> value_reg k))
                                                                                                                                                                                        (set! handler_reg handler)
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  (if (eq? (car temp_1) '<cont-48>)
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      (if (eq? (car temp_1) '<cont-49>)
                                                                                                                                                                                                          (let ((datum 'undefined)
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            (set! handler (list-ref temp_1 2))
                                                                                                                                                                                                            (set! datum (list-ref temp_1 1))
                                                                                                                                                                                                            (set! k_reg (make-cont '<cont-48> value_reg k))
                                                                                                                                                                                                            (set! handler_reg handler)
                                                                                                                                                                                                            (set! datum_reg (cdr datum))
                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont-59>)
                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                  (if (eq? (car temp_1) '<cont-60>)
                                                                                                                                                                                                                                                      (let ((operator 'undefined)
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        (set! k_reg (make-cont '<cont-59> value_reg env handler k))
                                                                                                                                                                                                                                                        (set! handler_reg handler)
                                                                                                                                                                                                                                                        (set! env_reg env)
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont-62>)
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont-63>)
                                                                                                                                                                                                                                                                  (let ((fexps 'undefined)
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    (set! k_reg (make-cont '<cont-62> value_reg k))
                                                                                                                                                                                                                                                                    (set! handler_reg handler)
                                                                                                                                                                                                                                                                    (set! env_reg env)
                                                                                                                                                                                                                                                                    (set! exps_reg fexps)
                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont-66>)
                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont-67>)
                                                                                                                                                                                                                                                                                  (let ((rhs-value 'undefined)
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    (set! k_reg (make-cont '<cont-66> value_reg rhs-value k))
                                                                                                                                                                                                                                                                                    (set! handler_reg handler)
                                                                                                                                                                                                                                                                                    (set! env_reg env)
                                                                                                                                                                                                                                                                                    (set! var_reg var)
                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                  (if (eq? (car temp_1) '<cont-68>)
                                                                                                                                                                                                                                                                                      (let ((rhs-exp 'undefined)
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        (set! k_reg
                                                                                                                                                                                                                                                                                          (make-cont '<cont-67> value_reg var env handler k))
                                                                                                                                                                                                                                                                                        (set! handler_reg handler)
                                                                                                                                                                                                                                                                                        (set! env_reg env)
                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                      (if (eq? (car temp_1) '<cont-69>)
                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont-70>)
                                                                                                                                                                                                                                                                                              (let ((var 'undefined)
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                (set! env (list-ref temp_1 2))
                                                                                                                                                                                                                                                                                                (set! var (list-ref temp_1 1))
                                                                                                                                                                                                                                                                                                (set! k_reg (make-cont '<cont-69> value_reg k))
                                                                                                                                                                                                                                                                                                (set! handler_reg handler)
                                                                                                                                                                                                                                                                                                (set! env_reg env)
                                                                                                                                                                                                                                                                                                (set! var_reg var)
                                                                                                                                                                                                                                                                                                (set! pc lookup-binding-in-first-frame))
                                                                          ...
                                                                          (if (eq? (car temp_1) '<cont2-18>)
                                                                              ...
                                                                              (if (eq? (car temp_1) '<cont2-19>)
                                                                                  (let ((handler 'undefined) (k 'undefined))
                                                                                    (set! k (list-ref temp_1 2))
                                                                                    (set! handler (list-ref temp_1 1))
                                                                                    (set! k_reg (make-cont '<cont-52> value2_reg handler k))
                                                                                    (set! handler_reg handler)
                                                                                    (set! datum_reg value1_reg)
                                                                                    (set! pc parse))
                                                                                              ...
                                                                                              (if (eq? (car temp_1) '<cont2-23>)
                                                                                                  ...
                                                                                                  (if (eq? (car temp_1) '<cont2-24>)
                                                                                                      (let ((env 'undefined) (handler 'undefined) (k 'undefined))
                                                                                                        ...
                                                                                                        (set! handler (list-ref temp_1 2))
                                                                                                        (set! env (list-ref temp_1 1))
                                                                                                        (set! k_reg (make-cont '<cont-89> value2_reg env handler k))
                                                                                                        (set! handler_reg handler)
                                                                                                        (set! datum_reg value1_reg)
                                                                                                        (set! pc parse))
                                                                                                      (if (eq? (car temp_1) '<cont2-25>)
                                                                                                          (begin
                                                                                                            (set! k_reg (make-cont '<cont-92>))
                                                                                                            (set! handler_reg init-handler)
                                                                                                            (set! datum_reg value1_reg)
                                                                                                            (set! pc parse))
                                                                                                          (error 'apply-cont2
              ...
              (if (eq? (car temp_1) '<handler-3>)
                  ...
                  (if (eq? (car temp_1) '<handler-4>)
                      (let ((fexps 'undefined)
                        ...
                        (set! env (list-ref temp_1 2))
                        (set! fexps (list-ref temp_1 1))
                        (set! k_reg (make-cont '<cont-73> exception_reg handler))
                        (set! handler_reg handler)
                        (set! env_reg env)
                        (set! exps_reg fexps)
                        (set! pc eval-sequence))
                          ...
                          (let ((cexps 'undefined)
                            ...
                            (let ((new-env 'undefined))
                              ...
                              (let ((catch-handler 'undefined))
                                ...
                                (set! k_reg (make-cont '<cont-63> fexps env handler k))
                                                                                                                                                                                          ...
                                                                                                                                                                                          (if (eq? (car temp_1) '<proc-46>)
                                                                                                                                                                                              ...
                                                                                                                                                                                              (if (eq? (car temp_1) '<proc-47>)
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  (if (eq? (car temp_1) '<proc-48>)
                                                                                                                                                                                                      (begin
                                                                                                                                                                                                        (set! k_reg (make-cont '<cont-76> handler_reg k2_reg))
                                                                                                                                                                                                        (set! datum_reg (car args_reg))
                                                                                                                                                                                                        (set! pc parse))
    ...
    (if (literal? datum_reg)
        ...
        (if (quote? datum_reg)
            ...
            (if (quasiquote? datum_reg)
                (begin
                  (set! k_reg (make-cont '<cont-31> handler_reg k_reg))
                        ...
                        (if (symbol? datum_reg)
                            ...
                            (if (syntactic-sugar? datum_reg)
                                ...
                                (if (if-then? datum_reg)
                                    (begin
                                      (set! k_reg
                                        (make-cont '<cont-37> datum_reg handler_reg k_reg))
                                      (set! datum_reg (cadr datum_reg))
                                      (set! pc parse))
                                    (if (if-else? datum_reg)
                                        (begin
                                          (set! k_reg
                                            (make-cont '<cont-35> datum_reg handler_reg k_reg))
                                          (set! datum_reg (cadr datum_reg))
                                          (set! pc parse))
                                        (if (assignment? datum_reg)
                                            (begin
                                              (set! k_reg (make-cont '<cont-32> datum_reg k_reg))
                                            ...
                                            (if (define? datum_reg)
                                                (if (mit-style? datum_reg)
                                                    ...
                                                    (if (= (length datum_reg) 3)
                                                        (begin
                                                          (set! k_reg (make-cont '<cont-30> datum_reg k_reg))
                                                          (set! datum_reg (caddr datum_reg))
                                                          (set! pc parse))
                                                        (begin
                                                          (set! k_reg
                                                            (make-cont '<cont-29> datum_reg handler_reg k_reg))
                                                          (set! datum_reg (cadddr datum_reg))
                                                          (set! pc parse))))
                                                (if (global? datum_reg)
                                                    (begin
                                                      (set! k_reg (make-cont '<cont-27> datum_reg k_reg))
                                                      (set! datum_reg (caddr datum_reg))
                                                      (set! pc parse))
...
(define*
  ...
  (lambda ()
    (if (null? pairs_reg)
        ...
        (begin
          (set! k_reg
            (make-cont '<cont-40> pairs_reg handler_reg k_reg))
...
(define*
  ...
  (lambda ()
    (if (null? datum-list_reg)
        ...
        (begin
          (set! k_reg
            (make-cont '<cont-42> datum-list_reg handler_reg k_reg))
                    ...
                    (if (unquote-splicing? (car datum_reg))
                        (if (null? (cdr datum_reg))
                            (begin
                              ...
                              (set! pc apply-cont))
                            (begin
                              (set! k_reg (make-cont '<cont-46> datum_reg k_reg))
                        ...
                        (if (quasiquote-list? datum_reg)
                            ...
                            (begin
                              (set! k_reg
                                (make-cont '<cont-44> datum_reg handler_reg k_reg))
                              (set! datum_reg (car datum_reg))
                              (set! pc expand-quasiquote))))))))))
...
(define*
  ...
  (lambda ()
    (if (null? datum_reg)
        ...
        (begin
          (set! k_reg
            (make-cont '<cont-49> datum_reg handler_reg k_reg))
          (set! datum_reg (car datum_reg))
          (set! pc expand-quasiquote)))))
        ...
        (if (eq? (car exp_reg) 'var-exp)
            ...
            (if (eq? (car exp_reg) 'if-exp)
                (let ((test-exp 'undefined)
                  ...
                  (set! k_reg
                    (make-cont '<cont-72> else-exp then-exp env_reg handler_reg
                      k_reg))
                ...
                (if (eq? (car exp_reg) 'assign-exp)
                    (let ((var 'undefined) (rhs-exp 'undefined))
                      ...
                      (set! k_reg
                        (make-cont '<cont-71> var env_reg handler_reg k_reg))
                      (set! exp_reg rhs-exp)
                      (set! pc m))
                    (if (eq? (car exp_reg) 'define-exp)
                        (let ((var 'undefined) (rhs-exp 'undefined))
                          ...
                          (if (= (length rhs-exp) 1)
                              (begin
                                (set! k_reg
                                  (make-cont '<cont-70> var env_reg handler_reg k_reg))
                                (set! exp_reg (car rhs-exp))
                                (set! pc m))
                              (begin
                                (set! k_reg
                                  (make-cont '<cont-68> rhs-exp var env_reg handler_reg
                                    k_reg))
                                (set! exp_reg (cadr rhs-exp))
                                (set! pc m))))
                        (if (eq? (car exp_reg) 'global-exp)
                            (let ((var 'undefined) (rhs-exp 'undefined))
                              (set! rhs-exp (list-ref exp_reg 2))
                              (set! var (list-ref exp_reg 1))
                              (set! k_reg (make-cont '<cont-65> var k_reg))
                              (set! exp_reg (car rhs-exp))
                              (set! pc m))
                            (if (eq? (car exp_reg) 'define-syntax-exp)
                                (let ((keyword 'undefined) (clauses 'undefined))
                                  ...
                                  (set! k_reg (make-cont '<cont-64> clauses k_reg))
                                  (set! env_reg macro-env)
                                  (set! var_reg keyword)
                                  (set! pc lookup-binding-in-first-frame))
                                                ...
                                                (if (eq? (car exp_reg) 'try-finally-exp)
                                                    (let ((body 'undefined) (fexps 'undefined))
                                                      ...
                                                      (let ((new-handler 'undefined))
                                                        ...
                                                        (set! k_reg
                                                          (make-cont '<cont-63> fexps env_reg handler_reg k_reg))
                                                        (set! handler_reg new-handler)
                                                        (set! exp_reg body)
                                                        (set! pc m)))
                                                    (if (eq? (car exp_reg) 'try-catch-finally-exp)
                                                        ...
                                                        (if (eq? (car exp_reg) 'raise-exp)
                                                            (let ((exp 'undefined))
                                                              ...
                                                              (set! k_reg (make-cont '<cont-61> handler_reg))
                                                              (set! exp_reg exp)
                                                              (set! pc m))
                                                            (if (eq? (car exp_reg) 'dict-exp)
                                                                ...
                                                                (if (eq? (car exp_reg) 'app-exp)
                                                                    (let ((operator 'undefined) (operands 'undefined))
                                                                      ...
                                                                      (set! k_reg
                                                                        (make-cont '<cont-60> operator env_reg handler_reg k_reg))
...
(define*
  ...
  (lambda ()
    (if (null? exps_reg)
        ...
        (begin
          (set! k_reg
            (make-cont '<cont-74> exps_reg env_reg handler_reg k_reg))
...
(define*
  ...
  (lambda ()
    (set! k_reg
      (make-cont '<cont-75> exps_reg env_reg handler_reg k_reg))
    (set! exp_reg (car exps_reg))
    (set! pc m)))
...
(define*
  ...
  (lambda ()
    (if (null? list1_reg)
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg (make-cont '<cont-78> list1_reg proc_reg k_reg))
              (set! list1_reg (cdr list1_reg))
              (set! pc map1))
            (begin
              (set! k2_reg
                (make-cont '<cont-77> list1_reg proc_reg env_reg handler_reg
                  k_reg))
  ...
  (lambda ()
    (if (null? list1_reg)
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg
                (make-cont '<cont-80> list1_reg list2_reg proc_reg k_reg))
              (set! list2_reg (cdr list2_reg))
              (set! list1_reg (cdr list1_reg))
              (set! pc map2))
            (begin
              (set! k2_reg
                (make-cont '<cont-79> list1_reg list2_reg proc_reg env_reg
                  handler_reg k_reg))
              (set! env2_reg env_reg)
...
(define*
  ...
  (lambda ()
    (if (null? (car lists_reg))
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg (make-cont '<cont-82> lists_reg proc_reg k_reg))
              (set! lists_reg (map cdr lists_reg))
              (set! pc mapN))
            (begin
              (set! k2_reg
                (make-cont '<cont-81> lists_reg proc_reg env_reg handler_reg
                  k_reg))
              (set! env2_reg env_reg)
    ...
    (let ((arg-list 'undefined))
      ...
      (if (null? (car arg-list))
          ...
          (if (dlr-exp? proc_reg)
              ...
              (begin
                (set! k2_reg
                  (make-cont '<cont-83> arg-list proc_reg env_reg handler_reg
                    k_reg))
                (set! env2_reg env_reg)
...
(define*
  ...
  (lambda ()
    (let ((sym 'undefined))
      ...
      (set! k_reg
        (make-cont '<cont-84> args_reg sym handler_reg k_reg))
    ...
    (let ((filename 'undefined))
      ...
      (if (null? (cdr args_reg))
          ...
          (let ((module-name 'undefined))
            ...
            (set! k_reg
              (make-cont '<cont-85> filename env_reg handler_reg k_reg))
        ...
        (if (not (string? filename_reg))
            ...
            (if (not (file-exists? filename_reg))
                ...
                (begin
                  ...
                  (set! k_reg
                    (make-cont '<cont-87> env_reg handler_reg k_reg))
...
(define*
  ...
  (lambda ()
    (if (null? filenames_reg)
        ...
        (begin
          (set! k_reg
            (make-cont '<cont-90> filenames_reg env_reg handler_reg
              k_reg))
...
(define*
  help-prim
  (lambda ()
    (set! k_reg (make-cont '<cont-91> k_reg))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (begin
              (set! k_reg
                (make-cont '<cont-93> pattern_reg var_reg k_reg))
    ...
    (if (pattern-variable? p1_reg)
        (if (pattern-variable? p2_reg)
            (begin
              ...
              (set! pc apply-cont))
            (begin
              (set! k_reg (make-cont '<cont-94> p1_reg p2_reg k_reg))
...
(define*
  ...
  (lambda ()
    (set! k_reg
      (make-cont '<cont-98> pair1_reg pair2_reg k_reg))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (if (pair? pattern_reg)
                (begin
                  (set! k_reg (make-cont '<cont-99> pattern_reg s_reg k_reg))
                  (set! pattern_reg (car pattern_reg))
                  (set! pc instantiate))
          ...
          (if (eq? (car temp_1) 'unit)
              ...
              (if (eq? (car temp_1) 'composite)
                  (let ((s1 'undefined) (s2 'undefined))
                    ...
                    (set! k_reg (make-cont '<cont-100> s2 k_reg))
                    (set! s_reg s1)
                    (set! pc apply-sub))
