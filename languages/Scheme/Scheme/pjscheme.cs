   ...
   new public static void apply_cont2 ()
   {
	 ...
	 if (true_q
		     ...
		     (object) symbol ("<cont2-11>"))))
	   {
		 ...
		 k_reg =
		    PJScheme.make_cont2 ((object) symbol ("<cont2-10>"),
					 (object) adatum, (object) cvar,
					 (object) senv, (object) value1_reg,
					 (object) info, (object) handler,
					 (object) k);
		 fail_reg = value2_reg;
		 handler_reg = handler;
		 senv_reg =
		    PJScheme.cons ((object) PJScheme.list ((object) cvar),
				   (object) senv);
		     ...
		     (object) symbol ("<cont2-44>"))))
	   {
	      ...
	      value1_reg =
		 PJScheme.replace_info ((object) value1_reg,
					(object) PJScheme.
					snoc ((object) macro_keyword,
					      (object) PJScheme.
					      get_source_info ((object)
							       value1_reg)));
	      k_reg = k;
	      pc = (Function) apply_cont2;
	   }
   ...
   new public static void apply_proc ()
   {
	 ...
	 if (true_q
		     ...
		     (object) symbol ("<proc-96>"))))
	   {
		...
		(PJScheme.
		 Eq ((object) PJScheme.car ((object) temp_1),
		     (object) symbol ("<proc-100>"))))
	    if (true_q
		((((bool) PJScheme.length_one_q ((object) args_reg))
		  && ((bool) PJScheme.
		      number_q ((object) PJScheme.car ((object) args_reg))))))
	      {
		 value2_reg = fail_reg;
		 value1_reg =
		    PJScheme.round ((object) PJScheme.
				    car ((object) args_reg));
		 k_reg = k2_reg;
		 pc = (Function) apply_cont2;
