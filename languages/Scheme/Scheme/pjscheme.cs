...
public class PJScheme:Scheme
{
	      ...
	      else
		{
		   ...
		   variants =
		      PJScheme.cddr ((object) PJScheme.
				     cdr_hat ((object) datum_reg));
		   variant_names =
		      PJScheme.get_variant_names ((object) variants);
		   tester_def =
		      PJScheme.append ((object) PJScheme.
				       list ((object) symbol ("define")),
				       (object) PJScheme.
		   ...
		   defines = PJScheme.get_defines ((object) variant_names);
		   value_reg =
		      PJScheme.append ((object) PJScheme.
   ...
   new public static object get_variant_names (object variants)
   {
	 ...
	 return ((object) PJScheme.
		 cons ((object) PJScheme.
		       get_sexp ((object) PJScheme.
				 car_hat ((object) PJScheme.
					  car ((object) variants))),
		       (object) PJScheme.get_variant_names ((object) PJScheme.
							    cdr ((object)
								 variants))));
   }

   new public static object get_defines (object variants)
   {
      if (true_q (PJScheme.null_q ((object) variants)))
	 return ((object) EmptyList);
      else
	 return ((object) PJScheme.
		 cons ((object) PJScheme.
		       list ((object) symbol ("lambda"),
			     (object) PJScheme.
			     list ((object) symbol ("name")),
			     (object) PJScheme.
			     list ((object) symbol ("define"),
				   (object) PJScheme.
				   list ((object) symbol ("unquote"),
					 (object) symbol ("name")),
				   (object) PJScheme.
				   list ((object) symbol ("lambda"),
					 (object) symbol ("args"),
					 ...
					 list ((object) symbol ("cons"),
					       ...
					       list ((object)
						     ...
						     list ((object)
							   ...
							   symbol ("name"))),
					       (object) symbol ("args"))))),
		       (object) PJScheme.get_defines ((object) PJScheme.
						      cdr ((object)
							   variants))));
   }
