                                                                                                                                                                                          ...
                                                                                                                                                                                          (if (eq? (car temp_1) '<cont-45>)
                                                                                                                                                                                              ...
                                                                                                                                                                                              (if (eq? (car temp_1) '<cont-46>)
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  (error 'apply-cont
                                                                                                                                                                                                    "bad continuation: ~a"
                                                                                                                                                                                                    k_reg))))))))))))))))))))))))))))))))))))))))))))))))
        (error 'apply-cont "invalid procedure: ~a" k_reg))))
                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont2-89>)
                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont2-90>)
                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                  (error 'apply-cont2
                                                                                                                                                                                                                                                                                                                                                                                    "bad continuation2: ~a"
                                                                                                                                                                                                                                                                                                                                                                                    k_reg))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
        (error 'apply-cont2 "invalid procedure: ~a" k_reg))))
...
(define*
  ...
  (lambda ()
    (if (pair? k_reg)
        ...
        (error 'apply-cont3 "invalid procedure: ~a" k_reg))))
                                                  ...
                                                  (if (eq? (car temp_1) '<cont4-11>)
                                                      ...
                                                      (if (eq? (car temp_1) '<cont4-12>)
                                                          ...
                                                          (error 'apply-cont4
                                                            "bad continuation4: ~a"
                                                            k_reg))))))))))))))
        (error 'apply-cont4 "invalid procedure: ~a" k_reg))))
              ...
              (if (eq? (car temp_1) '<fail-2>)
                  ...
                  (if (eq? (car temp_1) '<fail-3>)
                      (let ((exps 'undefined)
                        ...
                        (set! exps_reg (cdr exps))
                        (set! pc eval-choices))
                      (error 'apply-fail "bad fail-continuation: ~a" fail_reg)))))
        (error 'apply-fail "invalid procedure: ~a" fail_reg))))
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<proc-61>)
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<proc-62>)
                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                  (error 'apply-proc
                                                                                                                                                                                                                                                                    "bad procedure: ~a"
                                                                                                                                                                                                                                                                    proc_reg))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
        (error 'apply-proc "invalid procedure: ~a" proc_reg))))
                                      ...
                                      (if (eq? (car temp_1) '<macro-8>)
                                          ...
                                          (if (eq? (car temp_1) '<macro-9>)
                                              ...
                                              (error 'apply-macro
                                                ...
                                                macro_reg)))))))))))
        (error 'apply-macro "invalid procedure: ~a" macro_reg))))
