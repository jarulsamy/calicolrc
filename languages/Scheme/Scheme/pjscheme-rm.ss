                                                  ...
                                                  (if (eq? (car temp_1) '<proc-12>)
                                                      ...
                                                      (if (eq? (car temp_1) '<proc-13>)
                                                          ...
                                                          (if (eq? (car temp_1) '<proc-14>)
                                                              (begin
                                                                (set! value2_reg fail_reg)
                                                                (set! value1_reg (char->string args_reg))
                                                                (set! k_reg k2_reg)
                                                                (set! pc apply-cont2))
                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      (let ((proc 'undefined))
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        (if (not (procedure-object? proc))
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            (let ((fake-k 'undefined))
                                                                                                                                                                                                                                              (set! fake-k (make-proc '<proc-54> k2_reg))
                                                                                                                                                                                                                                              (if (dlr-exp? proc)
                                                                                                                                                                                                                                                  (begin
                                                                                                                                                                                                                                                    (set! value2_reg fail_reg)
...
(define closure
  (lambda (formals bodies env)
    (return* (make-proc '<proc-2> bodies formals env))))

(define mu-closure
  (lambda (formals runt bodies env)
    (return* (make-proc '<proc-3> bodies formals runt env))))
...
(define make-external-proc
  (lambda (external-function-object)
    (return* (make-proc '<proc-76> external-function-object))))
