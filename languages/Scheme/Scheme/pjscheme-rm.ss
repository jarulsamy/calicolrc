      ...
      (if (eq? (car temp_1) '<cont-1>)
          ...
          (if (eq? (car temp_1) '<cont-2>)
              ...
              (if (eq? (car temp_1) '<cont-3>)
                  (let ((x 'undefined) (info 'undefined) (k 'undefined))
                    (set! k (list-ref temp_1 3))
                    (set! info (list-ref temp_1 2))
                                                  ...
                                                  (if (eq? (car temp_1) '<cont-12>)
                                                      (let ((adatum 'undefined)
                                                        ...
                                                        (let ((formals-list 'undefined) (name 'undefined))
                                                          ...
                                                          (set! fail_reg fail)
                                                          (set! handler_reg handler)
                                                          (set! env_reg (extend env formals-list formals-list))
                                                              ...
                                                              (if (eq? (car temp_1) '<cont-15>)
                                                                  ...
                                                                  (if (eq? (car temp_1) '<cont-16>)
                                                                      (let ((env 'undefined)
                                                                        ...
                                                                        (set! info (list-ref temp_1 2))
                                                                        (set! env (list-ref temp_1 1))
                                                                        (set! k_reg (make-cont '<cont-15> env info handler fail k))
                                                                        (set! info_reg 'none)
                                                                        (set! x_reg value_reg)
                                                                        (set! pc annotate-cps))
                                                                                                              ...
                                                                                                              (if (eq? (car temp_1) '<cont-27>)
                                                                                                                  ...
                                                                                                                  (if (eq? (car temp_1) '<cont-28>)
                                                                                                                      (let ((aclauses 'undefined)
                                                                                                                        ...
                                                                                                                        (if value_reg
                                                                                                                            (begin
                                                                                                                              (set! k2_reg (make-cont2 '<cont2-45> fail k))
                                                                                                                                                                  ...
                                                                                                                                                                  (if (eq? (car temp_1) '<cont-40>)
                                                                                                                                                                      ...
                                                                                                                                                                      (if (eq? (car temp_1) '<cont-41>)
                                                                                                                                                                          (let ((env2 'undefined)
                                                                                                                                                                            ...
                                                                                                                                                                            (set! env2 (list-ref temp_1 1))
                                                                                                                                                                            (set! k_reg (make-cont2 '<cont2-70> env2 handler k2))
                                                                                                                                                                            (set! fail_reg fail)
                                                                                                                                                                            (set! handler_reg handler)
                                                                                                                                                                            (set! env_reg env2)
                                      ...
                                      (if (eq? (car temp_1) '<cont2-9>)
                                          ...
                                          (if (eq? (car temp_1) '<cont2-10>)
                                              (let ((adatum 'undefined)
                                                ...
                                                (set! adatum (list-ref temp_1 1))
                                                (set! k_reg
                                                  (make-cont2 '<cont2-9> adatum value1_reg body info k))
                                                (set! fail_reg value2_reg)
                                                (set! handler_reg handler)
                                                (set! env_reg env)
                                              ...
                                              (if (eq? (car temp_1) '<cont2-11>)
                                                  (let ((adatum 'undefined)
                                                    ...
                                                    (set! adatum (list-ref temp_1 1))
                                                    (set! k_reg
                                                      (make-cont2 '<cont2-10> adatum value1_reg env info handler
                                                        k))
                                                    (set! fail_reg value2_reg)
                                                    (set! handler_reg handler)
                                                    (set! env_reg env)
                                                          ...
                                                          (if (eq? (car temp_1) '<cont2-14>)
                                                              ...
                                                              (if (eq? (car temp_1) '<cont2-15>)
                                                                  (let ((adatum 'undefined)
                                                                    ...
                                                                    (set! adatum (list-ref temp_1 1))
                                                                    (set! k_reg
                                                                      (make-cont2 '<cont2-14> adatum value1_reg info k))
                                                                    (set! fail_reg value2_reg)
                                                                    (set! handler_reg handler)
                                                                    (set! env_reg env)
                                                                    (set! adatum-list_reg (catch-exps^ adatum))
                                                                  ...
                                                                  (if (eq? (car temp_1) '<cont2-16>)
                                                                      ...
                                                                      (if (eq? (car temp_1) '<cont2-17>)
                                                                          (let ((formals 'undefined) (info 'undefined) (k 'undefined))
                                                                            (set! k (list-ref temp_1 3))
                                                                            (set! info (list-ref temp_1 2))
                                                                                                      ...
                                                                                                      (if (eq? (car temp_1) '<cont2-25>)
                                                                                                          ...
                                                                                                          (if (eq? (car temp_1) '<cont2-26>)
                                                                                                              (let ((adatum 'undefined)
                                                                                                                ...
                                                                                                                (set! v1 (list-ref temp_1 2))
                                                                                                                (set! adatum (list-ref temp_1 1))
                                                                                                                (set! k_reg (make-cont2 '<cont2-25> v1 value1_reg info k))
                                                                                                                (set! fail_reg value2_reg)
                                                                                                                (set! handler_reg handler)
                                                                                                                (set! env_reg env)
                                                                                                              ...
                                                                                                              (if (eq? (car temp_1) '<cont2-27>)
                                                                                                                  (let ((adatum 'undefined)
                                                                                                                    ...
                                                                                                                    (set! adatum (list-ref temp_1 1))
                                                                                                                    (set! k_reg
                                                                                                                      (make-cont2 '<cont2-26> adatum value1_reg env info handler
                                                                                                                        k))
                                                                                                                    (set! fail_reg value2_reg)
                                                                                                                    (set! handler_reg handler)
                                                                                                                    (set! env_reg env)
                                                                                                                  ...
                                                                                                                  (if (eq? (car temp_1) '<cont2-28>)
                                                                                                                      ...
                                                                                                                      (if (eq? (car temp_1) '<cont2-29>)
                                                                                                                          (let ((adatum 'undefined)
                                                                                                                            ...
                                                                                                                            (set! env (list-ref temp_1 2))
                                                                                                                            (set! adatum (list-ref temp_1 1))
                                                                                                                            (set! k_reg (make-cont2 '<cont2-28> value1_reg info k))
                                                                                                                            (set! fail_reg value2_reg)
                                                                                                                            (set! handler_reg handler)
                                                                                                                            (set! env_reg env)
                                                                                                                            (set! adatum_reg (caddr^ adatum))
                                                                                                                              ...
                                                                                                                              (if (eq? (car temp_1) '<cont2-31>)
                                                                                                                                  ...
                                                                                                                                  (if (eq? (car temp_1) '<cont2-32>)
                                                                                                                                      (let ((adatum-list 'undefined)
                                                                                                                                        ...
                                                                                                                                        (set! k_reg (make-cont2 '<cont2-31> value1_reg k))
                                                                                                                                        (set! fail_reg value2_reg)
                                                                                                                                        (set! handler_reg handler)
                                                                                                                                        (set! env_reg env)
                                                                                                                                                          ...
                                                                                                                                                          (if (eq? (car temp_1) '<cont2-38>)
                                                                                                                                                              ...
                                                                                                                                                              (if (eq? (car temp_1) '<cont2-39>)
                                                                                                                                                                  ...
                                                                                                                                                                  (if (eq? (car temp_1) '<cont2-40>)
                                                                                                                                                                      (let ((type-tester-name 'undefined) (k 'undefined))
                                                                                                                                                                        (set! k (list-ref temp_1 2))
                                                                                                                                                                        (set! type-tester-name (list-ref temp_1 1))
                                                                                                                                                                      ...
                                                                                                                                                                      (if (eq? (car temp_1) '<cont2-41>)
                                                                                                                                                                          (let ((def 'undefined) (name 'undefined) (k2 'undefined))
                                                                                                                                                                            (set! k2 (list-ref temp_1 3))
                                                                                                                                                                            (set! name (list-ref temp_1 2))
                                                                                                                                                                            (set! def (list-ref temp_1 1))
                                                                                                                                                                            (set! value2_reg (cons def value2_reg))
                                                                                                                                                                            (set! value1_reg (cons name value1_reg))
                                                                                                                                                                            (set! k_reg k2)
                                                                                                                                                                            (set! pc apply-cont2))
                                                                                                                                                                          (if (eq? (car temp_1) '<cont2-42>)
                                                                                                                                                                              (let ((variants 'undefined) (k2 'undefined))
                                                                                                                                                                                (set! k2 (list-ref temp_1 2))
                                                                                                                                                                                (set! variants (list-ref temp_1 1))
                                                                                                                                                                                (set! k2_reg
                                                                                                                                                                                  (make-cont2 '<cont2-41> value2_reg value1_reg k2))
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont2-62>)
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont2-63>)
                                                                                                                                                                                                                                                                  (let ((var 'undefined)
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    (set! k_reg (make-cont2 '<cont2-62> value1_reg k))
                                                                                                                                                                                                                                                                    (set! fail_reg value2_reg)
                                                                                                                                                                                                                                                                    (set! handler_reg handler)
                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                      (if (eq? (car temp_1) '<cont2-65>)
                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont2-66>)
                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont2-67>)
                                                                                                                                                                                                                                                                                  (let ((trace-depth 'undefined) (k2 'undefined))
                                                                                                                                                                                                                                                                                    (set! k2 (list-ref temp_1 2))
                                                                                                                                                                                                                                                                                    (set! trace-depth (list-ref temp_1 1))
                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont2-71>)
                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                  (if (eq? (car temp_1) '<cont2-72>)
                                                                                                                                                                                                                                                                                                      (let ((env2 'undefined)
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        (set! handler (list-ref temp_1 2))
                                                                                                                                                                                                                                                                                                        (set! env2 (list-ref temp_1 1))
                                                                                                                                                                                                                                                                                                        (set! k_reg (make-cont4 '<cont4-11> env2 handler k2))
                                                                                                                                                                                                                                                                                                        (set! fail_reg value2_reg)
                                                                                                                                                                                                                                                                                                        (set! handler_reg handler)
                                                                                                                                                                                                                                                                                                        (set! src_reg 'stdin)
                                                                                                                                                                                                                                                                                                        (set! tokens_reg value1_reg)
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont2-74>)
                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont2-75>)
                                                                                                                                                                                                                                                                                                                  (let ((filename 'undefined)
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    (set! k_reg (make-cont2 '<cont2-74> k))
                                                                                                                                                                                                                                                                                                                    (set! fail_reg value2_reg)
                                                                                                                                                                                                                                                                                                                    (set! handler_reg handler)
                                                                                                                                                                                                                                                                                                                    (set! env_reg env)
                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                      (if (eq? (car temp_1) '<cont2-77>)
                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont2-78>)
                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont2-79>)
                                                                                                                                                                                                                                                                                                                                  (let ((ls1 'undefined) (k2 'undefined))
                                                                                                                                                                                                                                                                                                                                    (set! k2 (list-ref temp_1 2))
                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                  (if (eq? (car temp_1) '<cont2-80>)
                                                                                                                                                                                                                                                                                                                                      (let ((lists 'undefined) (k2 'undefined))
                                                                                                                                                                                                                                                                                                                                        (set! k2 (list-ref temp_1 2))
                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont2-86>)
                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont2-87>)
                                                                                                                                                                                                                                                                                                                                                                  (let ((lists 'undefined)
                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                    (set! lists (list-ref temp_1 1))
                                                                                                                                                                                                                                                                                                                                                                    (set! k_reg
                                                                                                                                                                                                                                                                                                                                                                      (make-cont2 '<cont2-33> value1_reg k))
                                                                                                                                                                                                                                                                                                                                                                    (set! fail_reg value2_reg)
                                                                                                                                                                                                                                                                                                                                                                    (set! handler_reg handler)
                                                                                                                                                                                                                                                                                                                                                                    (set! env_reg env)
                              ...
                              (if (eq? (car temp_1) '<cont4-7>)
                                  ...
                                  (if (eq? (car temp_1) '<cont4-8>)
                                      (let ((src 'undefined)
                                        ...
                                        (set! src (list-ref temp_1 1))
                                        (set! k_reg
                                          (make-cont2 '<cont2-34> src value3_reg env handler k))
                                        (set! fail_reg value4_reg)
                                        (set! handler_reg handler)
                                        (set! env_reg env)
                                        (set! adatum_reg value1_reg)
                  ...
                  (if (eq? (car temp_1) '<handler2-4>)
                      ...
                      (if (eq? (car temp_1) '<handler2-5>)
                          (let ((fexps 'undefined)
                            ...
                            (set! env (list-ref temp_1 2))
                            (set! fexps (list-ref temp_1 1))
                            (set! k_reg (make-cont2 '<cont2-66> exception_reg handler))
                            (set! handler_reg handler)
                            (set! env_reg env)
                            (set! exps_reg fexps)
                            (set! pc eval-sequence))
    ...
    (let ((temp_1 'undefined))
      ...
      (if (eq? (car temp_1) '<proc-1>)
          (let ((bodies 'undefined)
            ...
            (set! formals (list-ref temp_1 4))
            (set! trace-depth (list-ref temp_1 3))
            (set! name (list-ref temp_1 2))
            (set! bodies (list-ref temp_1 1))
            (if (= (length args_reg) (length formals))
                (begin
                  (printf
                    ...
                    (cons name args_reg))
                  (set! trace-depth (+ trace-depth 1))
                  (set! k_reg (make-cont2 '<cont2-67> trace-depth k2_reg))
          ...
          (if (eq? (car temp_1) '<proc-2>)
              (let ((bodies 'undefined)
                    ...
                    (runt 'undefined)
                    (env 'undefined))
                (set! env (list-ref temp_1 6))
                (set! runt (list-ref temp_1 5))
                (set! formals (list-ref temp_1 4))
                (set! trace-depth (list-ref temp_1 3))
                (set! name (list-ref temp_1 2))
                (set! bodies (list-ref temp_1 1))
                          ...
                          (if (eq? (car temp_1) '<proc-6>)
                              ...
                              (if (eq? (car temp_1) '<proc-7>)
                                  ...
                                  (if (eq? (car temp_1) '<proc-8>)
                                      (begin
                                        (set! k_reg
                                          (make-cont '<cont-41> env2_reg handler_reg fail_reg k2_reg))
                                        (set! info_reg 'none)
                                        (set! x_reg (car args_reg))
                                        (set! pc annotate-cps))
                                      (if (eq? (car temp_1) '<proc-9>)
                                          (if (list? (car args_reg))
                                              (begin
                                                (set! k_reg (make-cont2 '<cont2-71> k2_reg))
                                          ...
                                          (if (eq? (car temp_1) '<proc-10>)
                                              (begin
                                                (set! k_reg
                                                  (make-cont '<cont-42> env2_reg handler_reg fail_reg k2_reg))
                                                (set! info_reg 'none)
                                                (set! x_reg (car args_reg))
                                                (set! pc annotate-cps))
                                                      ...
                                                      (if (eq? (car temp_1) '<proc-13>)
                                                          ...
                                                          (if (eq? (car temp_1) '<proc-14>)
                                                              ...
                                                              (if (eq? (car temp_1) '<proc-15>)
                                                                  (begin
                                                                    (set! k_reg
                                                                      (make-cont2 '<cont2-72> env2_reg handler_reg k2_reg))
                                                                    (set! src_reg 'stdin)
                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                      (let ((filename 'undefined))
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        (if (null? (cdr args_reg))
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            (let ((module-name 'undefined))
                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                              (set! k_reg
                                                                                                                                                                                                                                                                                (make-cont2 '<cont2-77> filename env2_reg handler_reg
                                                                                                                                                                                                                                                                                  k2_reg))
                                                                                                                                                                                                                                                                              (set! env_reg env2_reg)
                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                      (let ((proc 'undefined))
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        (if (not (procedure-object? proc))
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            (let ((fake-k 'undefined))
                                                                                                                                                                                                                                                                                              (set! fake-k (make-proc '<proc-66> k2_reg))
                                                                                                                                                                                                                                                                                              (if (dlr-exp? proc)
                                                                                                                                                                                                                                                                                                  (begin
                                                                                                                                                                                                                                                                                                    (set! value2_reg fail_reg)
                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<proc-86>)
                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<proc-87>)
                                                                                                                                                                                                                                                                                                                                                                  (begin
                                                                                                                                                                                                                                                                                                                                                                    (set! value2_reg fail_reg)
                                                                                                                                                                                                                                                                                                                                                                    (set! value1_reg
                                                                                                                                                                                                                                                                                                                                                                      (apply vector-ref args_reg))
                                                                                                                                                                                                                                                                                                                                                                    (set! k_reg k2_reg)
                                                                                                                                                                                                                                                                                                                                                                    (set! pc apply-cont2))
                                                                                                                                                                                                                                                                                                                                                                  (if (eq? (car temp_1) '<proc-88>)
                                                                                                                                                                                                                                                                                                                                                                      (begin
                                                                                                                                                                                                                                                                                                                                                                        (set! value2_reg fail_reg)
                                                                                                                                                                                                                                                                                                                                                                        (set! value1_reg
                                                                                                                                                                                                                                                                                                                                                                          (apply make-vector args_reg))
                                                                                                                                                                                                                                                                                                                                                                        (set! k_reg k2_reg)
                                                                                                                                                                                                                                                                                                                                                                        (set! pc apply-cont2))
                                                                                                                                                                                                                                                                                                                                                                      (if (eq? (car temp_1) '<proc-89>)
                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<proc-90>)
                                                                                                                                                                                                                                                                                                                                                                              (if (not (length-two? args_reg))
                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                  (begin
                                                                                                                                                                                                                                                                                                                                                                                    (set! value2_reg fail_reg)
                                                                                                                                                                                                                                                                                                                                                                                    (set! value1_reg
                                                                                                                                                                                                                                                                                                                                                                                      (apply list-ref args_reg))
                                                                                                                                                                                                                                                                                                                                                                                    (set! k_reg k2_reg)
                                                                                                                                                                                                                                                                                                                                                                                    (set! pc apply-cont2)))
                                                                                                                                                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<proc-91>)
      ...
      (if (eq? (car temp_1) '<macro-1>)
          ...
          (if (eq? (car temp_1) '<macro-2>)
              (let ((decls 'undefined)
                ...
                (set! bodies (cddr^ datum_reg))
                (set! k2_reg (make-cont2 '<cont2-35> bodies k_reg))
                (set! procs_reg procs)
                (set! vars_reg vars)
                              ...
                              (if (eq? (car temp_1) '<macro-7>)
                                  ...
                                  (if (eq? (car temp_1) '<macro-8>)
                                      (let ((exp 'undefined) (clauses 'undefined))
                                        ...
                                        (set! k2_reg (make-cont2 '<cont2-37> exp k_reg))
                                          ...
                                          (if (eq? (car temp_1) '<macro-10>)
                                              (let ((datatype-name 'undefined)
                                                ...
                                                (if (not (eq?^ (caddr^ datum_reg) type-tester-name))
                                                    ...
                                                    (let ((variants 'undefined))
                                                      ...
                                                      (set! k2_reg
                                                        (make-cont2 '<cont2-40> type-tester-name k_reg))
                                              ...
                                              (if (eq? (car temp_1) '<macro-11>)
                                                  (let ((type-name 'undefined)
                                                    ...
                                                    (set! k2_reg
                                                      (make-cont2 '<cont2-43> exp type-name type-tester-name
                                                        k_reg))
                                                    (set! clauses_reg clauses)
                                                    (set! var_reg 'r)
                                                    (set! pc record-case-clauses->cond-clauses^))
...
(define empty-frame?
  (lambda (frame) (return* (= (vector-length frame) 0))))
...
(define*
  ...
  (lambda ()
    (set! frames_reg (cdr env_reg))
    (set! pc lookup-value-in-frames-by-lexical-address)))
  ...
  (lambda ()
    (if (= depth_reg 0)
        (begin
          (set! value2_reg fail_reg)
          (set! value1_reg
            (binding-value (vector-ref (car frames_reg) offset_reg)))
          (set! pc apply-cont2))
        (begin
          (set! frames_reg (cdr frames_reg))
    ...
    (let ((binding 'undefined))
      ...
      (if binding
          (begin
            ...
            (set! pc apply-cont2))
          (if (dlr-env-contains variable_reg)
              (begin
                (set! value2_reg fail_reg)
                (set! value1_reg (dlr-env-lookup variable_reg))
                (set! pc apply-cont2))
    ...
    (let ((strings 'undefined))
      ...
      (if (or (member "" strings) (= (length strings) 1))
          (begin
            ...
            (set! msg_reg (format "unbound variable ~a" variable_reg))
            (set! pc runtime-error))
          (begin
            (set! path_reg "")
            (set! components_reg (map string->symbol strings))
            (set! pc lookup-variable-components))))))
        ...
        (if binding
            ...
            (let ((new-binding 'undefined))
              ...
              (let ((new-frame 'undefined))
                (set! new-frame (vector-append frame (vector new-binding)))
...
(define*
  ...
  (lambda ()
    (let ((var 'undefined))
      ...
      (set! k_reg
        (make-cont2 '<cont2-4> components_reg path_reg var
          handler_reg k_reg))
      (set! var_reg var)
          ...
          (if (symbol?^ adatum_reg)
              (if *use-lexical-address*
                  (begin
                    (set! value2_reg fail_reg)
                    (set! value1_reg
                      (get-lexical-address env_reg (untag-atom^ adatum_reg) info))
                    (set! pc apply-cont2))
                  (begin
                    (set! value2_reg fail_reg)
              ...
              (if (vector?^ adatum_reg)
                  ...
                  (if (quote?^ adatum_reg)
                      ...
                      (if (quasiquote?^ adatum_reg)
                          (begin
                            (set! k_reg
                              (make-cont '<cont-18> adatum_reg env_reg info handler_reg
                                fail_reg k_reg))
                            (set! depth_reg 0)
                          ...
                          (if (unquote?^ adatum_reg)
                              ...
                              (if (unquote-splicing?^ adatum_reg)
                                  ...
                                  (if (syntactic-sugar?^ adatum_reg)
                                      (begin
                                        (set! k_reg
                                          (make-cont2 '<cont2-30> env_reg handler_reg k_reg))
                                        (set! pc expand-once^))
                                      (if (if-then?^ adatum_reg)
                                          (begin
                                            (set! k_reg
                                              (make-cont2 '<cont2-29> adatum_reg env_reg info handler_reg
                                                k_reg))
                                          ...
                                          (if (if-else?^ adatum_reg)
                                              (begin
                                                (set! k_reg
                                                  (make-cont2 '<cont2-27> adatum_reg env_reg info handler_reg
                                                    k_reg))
                                                (set! adatum_reg (cadr^ adatum_reg))
                                                (set! pc aparse))
                                                  ...
                                                  (if (func?^ adatum_reg)
                                                      ...
                                                      (if (define?^ adatum_reg)
                                                          (if (mit-style-define?^ adatum_reg)
                                                              (begin
                                                                (set! k_reg
                                                                  (make-cont '<cont-16> env_reg info handler_reg fail_reg
                                                                    k_reg))
                                                          ...
                                                          (if (define!?^ adatum_reg)
                                                              ...
                                                              (if (define-syntax?^ adatum_reg)
                                                                  ...
                                                                  (if (begin?^ adatum_reg)
                                                                      (begin
                                                                        (set! k_reg
                                                                          (make-cont2 '<cont2-18> adatum_reg info handler_reg k_reg))
                                                                        (set! adatum-list_reg (cdr^ adatum_reg))
                                                                        (set! pc aparse-all))
                                                                      (if (lambda?^ adatum_reg)
                                                                          (begin
                                                                            (set! k_reg
                                                                              (make-cont '<cont-13> adatum_reg env_reg info handler_reg
                                                                                fail_reg k_reg))
                                                                          ...
                                                                          (if (trace-lambda?^ adatum_reg)
                                                                              (begin
                                                                                (set! k_reg
                                                                                  (make-cont '<cont-12> adatum_reg env_reg info handler_reg
                                                                                    fail_reg k_reg))
                                                                              ...
                                                                              (if (try?^ adatum_reg)
                                                                                  (if (= (length^ adatum_reg) 2)
                                                                                      ...
                                                                                      (if (and (= (length^ adatum_reg) 3)
                                                                                          ...
                                                                                          (begin
                                                                                            (set! k_reg
                                                                                              (make-cont2 '<cont2-15> adatum_reg env_reg info handler_reg
                                                                                                k_reg))
                                                                                            (set! adatum_reg (try-body^ adatum_reg))
                                                                                            (set! pc aparse))
                                                                                          (if (and (= (length^ adatum_reg) 3)
                                                                                              ...
                                                                                              (begin
                                                                                                (set! k_reg
                                                                                                  (make-cont2 '<cont2-13> adatum_reg env_reg info handler_reg
                                                                                                    k_reg))
                                                                                                (set! adatum_reg (try-body^ adatum_reg))
                                                                                                (set! pc aparse))
                                                                                              (if (and (= (length^ adatum_reg) 4)
                                                                                                  ...
                                                                                                  (begin
                                                                                                    (set! k_reg
                                                                                                      (make-cont2 '<cont2-11> adatum_reg env_reg info handler_reg
                                                                                                        k_reg))
                                                                                                    (set! adatum_reg (try-body^ adatum_reg))
                                                                                                    (set! pc aparse))
                                                                                                  (begin
                                                                                  ...
                                                                                  (if (raise?^ adatum_reg)
                                                                                      ...
                                                                                      (if (choose?^ adatum_reg)
                                                                                          ...
                                                                                          (if (application?^ adatum_reg)
                                                                                              (begin
                                                                                                (set! k_reg
                                                                                                  (make-cont2 '<cont2-6> adatum_reg env_reg info handler_reg
                                                                                                    k_reg))
...
(define*
  ...
  (lambda ()
    (if (null?^ adatum-list_reg)
        ...
        (begin
          (set! k_reg
            (make-cont2 '<cont2-32> adatum-list_reg env_reg handler_reg
              k_reg))
...
(define*
  ...
  (lambda ()
    (if (token-type? (first tokens_reg) 'end-marker)
        ...
        (begin
          (set! k_reg
            (make-cont4 '<cont4-8> src_reg env_reg handler_reg k_reg))
          (set! pc read-sexp)))))
...
(define*
  ...
  (lambda ()
    (if (null?^ vars_reg)
        ...
        (begin
          (set! k2_reg
            (make-cont2 '<cont2-36> procs_reg vars_reg k2_reg))
...
(define*
  ...
  (lambda ()
    (if (null?^ clauses_reg)
        ...
        (begin
          (set! k2_reg
            (make-cont2 '<cont2-38> clauses_reg var_reg k2_reg))
          (set! clauses_reg (cdr^ clauses_reg))
          (set! pc case-clauses->cond-clauses^)))))
  ...
  (lambda ()
    (if (null?^ variants_reg)
        (begin
          ...
          (set! pc apply-cont2))
        (begin
          (set! k2_reg (make-cont2 '<cont2-42> variants_reg k2_reg))
...
(define*
  ...
  (lambda ()
    (let ((macro-keyword 'undefined))
      ...
      (set! k_reg
        (make-cont2 '<cont2-44> adatum_reg macro-keyword handler_reg
          k_reg))
      (set! var-info_reg 'none)
      (set! env_reg macro-env)
      (set! variable_reg macro-keyword)
      (set! pc lookup-value))))
...
(define get-lexical-address-frames
  (lambda (frames variable depth offset info)
    (if (null? frames)
        (return* (var-aexp variable info))
        (let ((result 'undefined))
          (set! result
            (get-lexical-address-frame (car frames) variable depth
              offset info))
          (if (not (car result))
              (return*
...
(define get-lexical-address-frame
  (lambda (frame variable depth offset info)
    (if (empty-frame? frame)
        (return* (list #f))
        (if (>= offset (vector-length frame))
            (return* (list #f))
            (if (eq? (binding-variable (vector-ref frame offset))
                     variable)
                (return*
              ...
              (if (eq? (car exp_reg) 'lexical-address-aexp)
                  ...
                  (if (eq? (car exp_reg) 'func-aexp)
                      (let ((exp 'undefined))
                        ...
                        (set! k_reg (make-cont2 '<cont2-65> k))
                        (set! exp_reg exp)
                        (set! pc m))
                      (if (eq? (car exp_reg) 'if-aexp)
                          (let ((test-exp 'undefined)
                            ...
                            (set! k_reg
                              (make-cont2 '<cont2-64> else-exp then-exp env_reg
                                handler_reg k))
                          ...
                          (if (eq? (car exp_reg) 'assign-aexp)
                              (let ((var 'undefined)
                                ...
                                (set! k_reg
                                  (make-cont2 '<cont2-63> var var-info env_reg handler_reg k))
                                (set! exp_reg rhs-exp)
                                (set! pc m))
                              (if (eq? (car exp_reg) 'define-aexp)
                                  (let ((var 'undefined)
                                    ...
                                    (set! var (list-ref exp_reg 1))
                                    (set! k_reg
                                      (make-cont2 '<cont2-61> docstring var env_reg handler_reg
                                        k))
                                    (set! exp_reg rhs-exp)
                                    (set! pc m))
                                  (if (eq? (car exp_reg) 'define!-aexp)
...
(define*
  ...
  (lambda ()
    (if (null? exps_reg)
        ...
        (begin
          (set! k_reg
            (make-cont2 '<cont2-68> exps_reg env_reg handler_reg k_reg))
          (set! exp_reg (car exps_reg))
          (set! pc m)))))
...
(define*
  ...
  (lambda ()
    (if (null? (cdr exps_reg))
        ...
        (begin
          (set! k_reg
            (make-cont2 '<cont2-69> exps_reg env_reg handler_reg k_reg))
          (set! exp_reg (car exps_reg))
          (set! pc m)))))
        ...
        (if (not (string? filename_reg))
            ...
            (if (not (file-exists? filename_reg))
                ...
                (begin
                  ...
                  (set! k_reg
                    (make-cont2 '<cont2-75> filename_reg env_reg handler_reg
                      k_reg))
...
(define*
  ...
  (lambda ()
    (if (null? filenames_reg)
        ...
        (begin
          (set! k_reg
            (make-cont2 '<cont2-76> filenames_reg env_reg info_reg
              handler_reg k_reg))
...
(define*
  ...
  (lambda ()
    (let ((sym 'undefined))
      ...
      (set! k_reg
        (make-cont2 '<cont2-78> args_reg sym info_reg handler_reg
          k_reg))
      (set! var-info_reg 'none)
  ...
  (lambda ()
    (if (null? ls1_reg)
        (begin
          ...
          (set! pc apply-cont2))
        (begin
          (set! k2_reg (make-cont2 '<cont2-79> ls1_reg k2_reg))
        ...
        (if (null? (cdr lists_reg))
            ...
            (if (not (list? (car lists_reg)))
                (begin
                  ...
                  (set! pc runtime-error))
                (begin
                  (set! k2_reg (make-cont2 '<cont2-80> lists_reg k2_reg))
...
(define get-variables-from-frame
  (lambda (frame)
    (return* (map binding-variable (vector->list frame)))))

(define get-variables-from-frames
  (lambda (frames)
    (return* (map get-variables-from-frame frames))))
  ...
  (lambda ()
    (let ((item 'undefined))
      ...
      (if (null? item)
          ...
          (begin
            (set! k2_reg
              (make-cont2 '<cont2-82> iterator_reg proc_reg env_reg
                handler_reg k_reg))
            (set! info_reg 'none)
            (set! env2_reg env_reg)
            (set! args_reg (list item))
  ...
  (lambda ()
    (if (null? list1_reg)
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg
                (make-cont2 '<cont2-84> list1_reg proc_reg k_reg))
              (set! list1_reg (cdr list1_reg))
              (set! pc map1))
            (begin
              (set! k2_reg
                (make-cont2 '<cont2-83> list1_reg proc_reg env_reg
                  handler_reg k_reg))
              (set! info_reg 'none)
              (set! env2_reg env_reg)
  ...
  (lambda ()
    (if (null? list1_reg)
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg
                (make-cont2 '<cont2-86> list1_reg list2_reg proc_reg k_reg))
              (set! list2_reg (cdr list2_reg))
              (set! list1_reg (cdr list1_reg))
              (set! pc map2))
            (begin
              (set! k2_reg
                (make-cont2 '<cont2-85> list1_reg list2_reg proc_reg env_reg
                  handler_reg k_reg))
              (set! info_reg 'none)
              (set! env2_reg env_reg)
  ...
  (lambda ()
    (if (null? (car lists_reg))
        ...
        (if (dlr-exp? proc_reg)
            (begin
              (set! k_reg
                (make-cont2 '<cont2-88> lists_reg proc_reg k_reg))
              (set! lists_reg (map cdr lists_reg))
              (set! pc mapN))
            (begin
              (set! k2_reg
                (make-cont2 '<cont2-87> lists_reg proc_reg env_reg
                  handler_reg k_reg))
              (set! info_reg 'none)
              (set! env2_reg env_reg)
        ...
        (let ((arg-list 'undefined))
          ...
          (if (null? (car arg-list))
              ...
              (if (dlr-exp? proc_reg)
                  ...
                  (begin
                    (set! k2_reg
                      (make-cont2 '<cont2-89> arg-list proc_reg env_reg
                        handler_reg k_reg))
                    (set! info_reg 'none)
                    (set! env2_reg env_reg)
    ...
    (let ((primitives 'undefined))
      (set! primitives
        (list (list '* times-prim) (list '+ plus-prim)
         ...
         (list 'eval eval-prim) (list 'eval-ast eval-ast-prim)
         (list 'exit exit-prim) (list 'for-each for-each-prim)
         (list 'get get-prim) (list 'import import-prim)
...
(define make-external-proc
  (lambda (external-function-object)
    (return* (make-proc '<proc-91> external-function-object))))
    ...
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (if (pair? pattern_reg)
                (begin
                  (set! k2_reg
                    (make-cont2 '<cont2-93> ap_reg pattern_reg s_reg k2_reg))
          ...
          (if (eq? (car temp_1) 'unit)
              ...
              (if (eq? (car temp_1) 'composite)
                  (let ((s1 'undefined) (s2 'undefined))
                    ...
                    (set! k2_reg (make-cont2 '<cont2-94> s2 k2_reg))
                    (set! s_reg s1)
                    (set! pc apply-sub^))
...
(define-native
  ...
  (lambda (frame variable)
    (if (empty-frame? frame)
        (return* #f)
        (return* (search-frame-position frame variable 0)))))

(define-native
  search-frame-position
  (lambda (frame variable position)
    (if (>= position (vector-length frame))
        (return* #f)
        (if (eq? (binding-variable (vector-ref frame position))
                 variable)
            (return* (vector-ref frame position))
            (return*
...
(define-native
  vector_native
  (lambda args (return* (apply vector args))))
