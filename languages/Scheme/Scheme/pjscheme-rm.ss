      ...
      (if (eq? (car temp_1) '<cont-1>)
          ...
          (if (eq? (car temp_1) '<cont-2>)
              (let ((clauses 'undefined)
                ...
                (if value_reg
                    (begin
                      (set! k_reg (make-cont '<cont-1> fail k))
                      (set! s_reg value_reg)
                              ...
                              (if (eq? (car temp_1) '<cont-7>)
                                  ...
                                  (if (eq? (car temp_1) '<cont-8>)
                                      (let ((datum 'undefined) (k 'undefined))
                                        ...
                                        (set! k_reg (make-cont '<cont-7> value_reg k))
                                                  ...
                                                  (if (eq? (car temp_1) '<cont-12>)
                                                      ...
                                                      (if (eq? (car temp_1) '<cont-13>)
                                                          (let ((datum 'undefined) (k 'undefined))
                                                            (set! k (list-ref temp_1 2))
                                                            (set! datum (list-ref temp_1 1))
                                                            (set! k_reg (make-cont '<cont-12> value_reg k))
                                                            (set! datum_reg (cdr datum))
                                                                                  ...
                                                                                  (if (eq? (car temp_1) '<cont-20>)
                                                                                      ...
                                                                                      (if (eq? (car temp_1) '<cont-21>)
                                                                                          (let ((new-cdr1 'undefined)
                                                                                            ...
                                                                                            (set! k_reg (make-cont '<cont-20> s-car k))
                                                                                          ...
                                                                                          (if (eq? (car temp_1) '<cont-22>)
                                                                                              (let ((pair2 'undefined) (s-car 'undefined) (k 'undefined))
                                                                                                ...
                                                                                                (set! k_reg (make-cont '<cont-21> value_reg s-car k))
                                                                                                (set! s_reg s-car)
                                                                                                  ...
                                                                                                  (let ((pair1 'undefined) (pair2 'undefined) (k 'undefined))
                                                                                                    ...
                                                                                                    (if (not value_reg)
                                                                                                        (begin
                                                                                                          ...
                                                                                                          (set! pc apply-cont))
                                                                                                        (begin
                                                                                                          (set! k_reg (make-cont '<cont-22> pair2 value_reg k))
                                                                                                          (set! s_reg value_reg)
                                          ...
                                          (let ((datum 'undefined)
                                            ...
                                            (if (pattern-macro? value1_reg)
                                                (begin
                                                  ...
                                                  (set! pc process-macro-clauses))
                                                (begin
                                                  (set! k_reg (make-cont '<cont-1> value2_reg k))
                                                  (set! datum_reg datum)
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  (if (eq? (car temp_1) '<cont2-48>)
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      (if (eq? (car temp_1) '<cont2-49>)
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont2-50>)
                                                                                                                                                                                                              (begin
                                                                                                                                                                                                                (if (not (eq? value1_reg void-value))
                                                                                                                      ...
                                                                                                                      (if (eq? (car temp_1) '<proc-29>)
                                                                                                                          ...
                                                                                                                          (if (eq? (car temp_1) '<proc-30>)
                                                                                                                              ...
                                                                                                                              (if (eq? (car temp_1) '<proc-31>)
                                                                                                                                  (if (= (length args_reg) 2)
                                                                                                                                      (begin
                                                                                                                                        (set! k_reg (make-cont '<cont-14> fail_reg k2_reg))
  ...
  (lambda ()
    (if (null? clauses_reg)
        ...
        (let ((left-pattern 'undefined) (right-pattern 'undefined))
          ...
          (set! k_reg
            (make-cont '<cont-2> clauses_reg datum_reg right-pattern
  ...
  (lambda ()
    (if (or (null? bindings_reg) (null? (cdr bindings_reg)))
        (begin
          ...
          (set! pc apply-cont))
        (begin
          (set! k_reg (make-cont '<cont-3> bindings_reg k_reg))
...
(define*
  ...
  (lambda ()
    (if (null? clauses_reg)
        ...
        (begin
          (set! k_reg (make-cont '<cont-5> clauses_reg var_reg k_reg))
    ...
    (if (literal? datum_reg)
        ...
        (if (quote? datum_reg)
            ...
            (if (quasiquote? datum_reg)
                (begin
                  (set! k_reg
                    (make-cont '<cont-6> handler_reg fail_reg k_reg))
...
(define*
  ...
  (lambda ()
    (if (vector? datum_reg)
        (begin
          (set! k_reg (make-cont '<cont-11> k_reg))
                    ...
                    (if (unquote-splicing? (car datum_reg))
                        (if (null? (cdr datum_reg))
                            (begin
                              ...
                              (set! pc apply-cont))
                            (begin
                              (set! k_reg (make-cont '<cont-10> datum_reg k_reg))
                              (set! datum_reg (cdr datum_reg))
                              (set! pc expand-quasiquote)))
                        (if (quasiquote-list? datum_reg)
                            (begin
                              (set! k_reg (make-cont '<cont-9> k_reg))
                              (set! pc expand-quasiquote-list))
                            (begin
                              (set! k_reg (make-cont '<cont-8> datum_reg k_reg))
                              (set! datum_reg (car datum_reg))
                              (set! pc expand-quasiquote))))))))))
...
(define*
  ...
  (lambda ()
    (if (null? datum_reg)
        (begin (set! value_reg '()) (set! pc apply-cont))
        (begin
          (set! k_reg (make-cont '<cont-13> datum_reg k_reg))
          (set! datum_reg (car datum_reg))
          (set! pc expand-quasiquote)))))
  ...
  (lambda ()
    (if (or (and (null? x_reg) (null? y_reg))
        ...
        (if (and (pair? x_reg) (pair? y_reg))
            (begin
              (set! k_reg (make-cont '<cont-15> x_reg y_reg k_reg))
              (set! y_reg (car y_reg))
              (set! x_reg (car x_reg))
              (set! pc equal-objects?))
            (if (and (vector? x_reg)
...
(define*
  ...
  (lambda ()
    (if (< i_reg 0)
        ...
        (begin
          (set! k_reg
            (make-cont '<cont-16> i_reg v1_reg v2_reg k_reg))
  ...
  (lambda ()
    (if (null? ls_reg)
        ...
        (if (not (pair? ls_reg))
            ...
            (begin
              (set! k_reg
                (make-cont '<cont-17> ls_reg orig-ls_reg x_reg handler_reg
                  fail_reg k_reg))
...
(define*
  ...
  (lambda ()
    (let ((fake-k 'undefined))
      (set! fake-k (make-proc '<proc-58> k_reg))
      (if (dlr-exp? proc_reg)
          (begin
            (set! value2_reg fail_reg)
...
(define make-external-proc
  (lambda (external-function-object)
    (return* (make-proc '<proc-59> external-function-object))))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (begin
              (set! k_reg
                (make-cont '<cont-18> pattern_reg var_reg k_reg))
    ...
    (if (pattern-variable? p1_reg)
        (if (pattern-variable? p2_reg)
            (begin
              ...
              (set! pc apply-cont))
            (begin
              (set! k_reg (make-cont '<cont-19> p1_reg p2_reg k_reg))
...
(define*
  ...
  (lambda ()
    (set! k_reg
      (make-cont '<cont-23> pair1_reg pair2_reg k_reg))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (if (pair? pattern_reg)
                (begin
                  (set! k_reg (make-cont '<cont-25> pattern_reg s_reg k_reg))
                  (set! pattern_reg (car pattern_reg))
                  (set! pc instantiate))
          ...
          (if (eq? (car temp_1) 'unit)
              ...
              (if (eq? (car temp_1) 'composite)
                  (let ((s1 'undefined) (s2 'undefined))
                    ...
                    (set! k_reg (make-cont '<cont-26> s2 k_reg))
                    (set! s_reg s1)
                    (set! pc apply-sub))
